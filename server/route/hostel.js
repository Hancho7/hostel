...
const {getNamesOfHostelForthisAdmin,getSpecificHostelDetails,retrieveHostelsForHomePage,getSpecificHostelImages, retrieveAllHostels, userSearchHostels} = require("../controllers/hostel/retrieve")
...
studentRouter.get("/get-specific-hostel-images/:hostelID", getSpecificHostelImages);
